...
#write.table(mass_data, './data/mass_data_info.tsv', row.names=F, col.names=T, sep='\t', quote=F)
...
#write.table(mass_data_filtered, './data/mass_data_info_filtered.tsv', row.names=F, col.names=T, sep='\t', quote=F)

mass_data_filtered <- mass_data_filtered %>% filter(instrument_type != 'LC-ESI-Q')
#write.table(mass_data_filtered, './data/mass_data_to_standardisation.tsv', row.names=F, col.names=T, sep='\t', quote=F)
```
